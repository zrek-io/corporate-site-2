  ...
  return (
    <Box>
      ...
      <Box as="main" display="flex" flexWrap="wrap" justifyContent="space-between" w={{ sm: '90%', md: '80%', lg: "73%" }} mx="auto" my={32}>
        <NewsItem date="2022.7.1" tag="サービス" title="NFT事業を開始しました" />
        <NewsItem date="2022.3.28" tag="コーポレート" title="本店を移転しました" />
        ...
        <NewsItem date="2021.6.13" tag="コーポレート" title="元東京都議会議員 鈴木隆道氏が顧問に就任しました" />
