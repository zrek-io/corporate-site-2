    ...
    <Box>
      ...
      >
        ...
        <Box w="100%" mb={20}>
          ...
          <Box w={{ sm: "85%", lg: "60%" }} mx="auto" lineHeight={8}>
            <Text py={5}>
              社名の「ゼットレック」に相応しいロゴとして考えられました。
            </Text>
            <Text py={5}>
              ロゴのモチーフとなったのは、地球上で最も長距離の渡りをする鳥の一つとして知られているキョクアジサシです。キョクアジサシは、チドリ目のカモメ科に分類される鳥類の一種で、1年のうちに北極圏と南極圏の間を往き来する鳥です。
            </Text>
            <Text py={5}>
              どんな困難があろうとも、誰よりも遠くまで飛ぶことをイメージして、デザインされました。
            </Text>
            <Text py={5}>
              中央のうねりは、道中における波を表しています。決して、喜びや楽しさだけではありませんが、最後には必ず超えてゆくことができる波です。
            </Text>
          </Box>
        </Box>
        <Box w="100%" mb={20}>
